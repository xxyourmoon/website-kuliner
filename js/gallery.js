...
var ExpandPreview = (function () {
  ...
  function initItemsEvents($items) {
    $items
      .on("click", "span.preview-close", function () {
        hidePreview();
        return false;
      })
      .children("a")
  ...
  Preview.prototype = {
    create: function () {
      ...
      this.$details = $('<div class="preview-details"></div>').append(
        this.$title,
        this.$description,
        this.$href,
      );
      this.$loading = $('<div class="preview-loading"></div>');
      this.$fullimage = $('<div class="preview-fullimg"></div>').append(
        this.$loading,
      );
      this.$closePreview = $('<span class="preview-close"></span>');
      this.$previewInner = $(
        '<div class="preview-expander-inner"></div>',
      ).append(this.$closePreview, this.$fullimage, this.$details);
      this.$previewEl = $('<div class="preview-expander"></div>').append(
        this.$previewInner,
      );
